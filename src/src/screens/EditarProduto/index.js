  ...
  React.useEffect(() => {
    axios
      ...
      .then(res => {
        ...
        setNomeFabricante(data.brand);
        setCategoria(data.category);

        if(data.size === 'P' || data.size === 'M' || data.size === 'G') {
          document.getElementById(`input-dimensions-checkbox-1`).checked = true;
          setIsChecked(true);
          
          document.getElementById(`input-dimensions-checkbox-${data.size}`).checked = true;          
        } else {
          document.getElementById(`input-dimensions-checkbox-2`).checked = true;
        }
        ...
        document.getElementById('input-descricao').innerHTML = data.description;
        setDescricao(data.description);

        setImagem1(data.banner);
        setImagem2(data.images[0]);
        setImagem3(data.images[1]);
        setImagem4(data.images[2]);
        setImagem5(data.images[3]);
      })
  }, []);
